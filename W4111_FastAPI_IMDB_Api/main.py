...
async def get_artist(nconst: str) -> ArtistRsp:
    ...
    :param nconst: The IMDB nconst primary key for the information from name_basics_all.
...
@app.get("/api/artist/", response_model=ArtistRsp)
async def get_artist(primaryName = None, birthYear = None, deathYear = None) -> ArtistRsp:
   
    result = artist_resource.get(primaryName, birthYear, deathYear)
    return result
"""
"""
cal2266 code 
